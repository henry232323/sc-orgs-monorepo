...
export enum NotificationEntityType {
  ...
  HR_ONBOARDING_STARTED = 62,
  HR_ONBOARDING_COMPLETED = 63,
  HR_ONBOARDING_OVERDUE = 64,
  HR_PERFORMANCE_REVIEW_DUE = 65,
  HR_PERFORMANCE_REVIEW_SUBMITTED = 66,
  HR_SKILL_VERIFIED = 67,
  HR_CERTIFICATION_EXPIRING = 68,
  HR_DOCUMENT_REQUIRES_ACKNOWLEDGMENT = 69,
  HR_ANALYTICS_ALERT = 70,
}
