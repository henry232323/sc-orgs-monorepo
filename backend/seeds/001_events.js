      ...
      const events = [
        {
          ...
          languages: ['English'],
          playstyle_tags: ['Hardcore', 'Military'],
          activity_tags: ['Combat', 'Fleet Operations'],
          max_participants: 50,
          is_public: true,
          is_active: true,
        ...
        },
        {
          ...
          languages: ['English'],
          playstyle_tags: ['Casual', 'Social'],
          activity_tags: ['Trading', 'Exploration'],
          max_participants: 20,
          is_public: true,
          is_active: true,
        ...
        },
        {
          ...
          languages: ['English'],
          playstyle_tags: ['Casual', 'Industrial'],
          activity_tags: ['Mining', 'Industrial'],
          max_participants: 15,
          is_public: true,
          is_active: true,
        ...
        },
        {
          ...
          languages: ['English'],
          playstyle_tags: ['Competitive', 'Racing'],
          activity_tags: ['Racing', 'Competition'],
          max_participants: 30,
          is_public: true,
          is_active: true,
        ...
        },
        {
          ...
          languages: ['English'],
          playstyle_tags: ['Hardcore', 'Exploration'],
          activity_tags: ['Exploration', 'Discovery'],
          max_participants: 10,
          is_public: true,
          is_active: true,
        ...
        },
        {
          ...
          languages: ['English'],
          playstyle_tags: ['Hardcore', 'Combat'],
          activity_tags: ['Bounty Hunting', 'Combat'],
          max_participants: 25,
          is_public: true,
          is_active: true,
